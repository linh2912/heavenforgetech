...
const TRANSLATIONS = {
  ...
  'nav.products.about': { vi: 'Giới thiệu', en: 'About' },
  'nav.products.usage': { vi: 'Cách sử dụng', en: 'Usage' },
  ...
  'products.showcase.title': { vi: 'Các Chức Năng Cốt Lõi', en: 'Core Features' },
...
,
  ...
  // About Page
  'about.title': { vi: 'Khám phá <span class="accent">ForgeCore</span>', en: 'Discover <span class="accent">ForgeCore</span>' },
  'about.sub': { vi: 'Hệ thống quản lý kho hàng và bán hàng toàn diện, giúp doanh nghiệp tối ưu quy trình và nắm bắt mọi thông tin chỉ trên một nền tảng duy nhất.', en: 'Comprehensive warehouse and sales management system, helping businesses optimize processes and capture all information on a single platform.' },
  'about.p1': { vi: 'Trong bối cảnh kinh doanh hiện đại, việc quản lý doanh nghiệp không chỉ dừng lại ở những con số khô khan. Tại <strong>HeavenForge Tech</strong>, chúng tôi hiểu rằng mỗi quyết định của bạn đều cần một nền tảng dữ liệu vững chắc, trực quan và an toàn. Đó là lý do <strong>ForgeCore</strong> ra đời — không chỉ là một phần mềm, mà là một người trợ lý đắc lực đồng hành cùng sự phát triển của bạn.', en: 'In the modern business context, enterprise management is more than just dry numbers. At <strong>HeavenForge Tech</strong>, we understand that every decision needs a solid, visual, and secure data foundation. That is why <strong>ForgeCore</strong> was born — not just software, but a powerful assistant accompanying your growth.' },
  'about.toc': { vi: 'Mục lục', en: 'Table of Contents' },
  'about.toc.1': { vi: '1. Bức tranh toàn cảnh', en: '1. The Big Picture' },
  'about.toc.2': { vi: '2. Bảo mật & Phân quyền', en: '2. Security & Authorization' },
  'about.toc.3': { vi: '3. Dấu vết hệ thống', en: '3. System Audit Trails' },
  'about.toc.4': { vi: '4. Tự động hóa nhập liệu', en: '4. Automated Data Entry' },
  'about.toc.5': { vi: '5. Linh hoạt & Đa ngôn ngữ', en: '5. Flexibility & Multilingual' },
  'about.h2.1': { vi: '1. Bức tranh toàn cảnh trong tầm tay', en: '1. The Big Picture at Your Fingertips' },
  'about.p2.1': { vi: 'Hãy tưởng tượng bạn bước vào văn phòng vào mỗi buổi sáng, thay vì phải lật giở từng trang báo cáo hay mở hàng tá file Excel, bạn chỉ cần mở bảng điều khiển (Dashboard) của ForgeCore. Mọi thông số quan trọng nhất của doanh nghiệp đều hiện ra sống động. Hệ thống tự động tổng hợp số lượng vật tư sắp hết, thống kê chi tiết các phiếu nhập, phiếu xuất và vẽ nên bức tranh doanh thu thông qua các biểu đồ trực quan. Bạn hoàn toàn làm chủ dòng chảy của dữ liệu chỉ qua vài cú click chuột.', en: 'Imagine stepping into your office every morning, instead of flipping through report pages or opening dozens of Excel files, you just open the ForgeCore Dashboard. All crucial business metrics come alive. The system automatically compiles low-stock items, details import/export receipts, and paints a revenue picture via intuitive charts. You fully master the data flow with just a few clicks.' },
  'about.h2.2': { vi: '2. An tâm tuyệt đối với cơ chế bảo mật và phân quyền', en: '2. Absolute Peace of Mind with Security & Authorization' },
  'about.p2.2': { vi: 'Khi quy mô nhân sự mở rộng, bài toán phân quyền trở thành thách thức lớn. Hệ thống bảo mật của chúng tôi được thiết kế với tư duy <em>"đúng người, đúng việc"</em>. Cơ chế phân quyền thông minh cho phép người quản lý dễ dàng thiết lập giới hạn truy cập cho từng phòng ban, từng nhân viên. Dữ liệu nhạy cảm được bảo vệ nghiêm ngặt, ngăn chặn những can thiệp ngoài ý muốn, đồng thời vẫn đảm bảo sự trơn tru trong luồng công việc của một nhóm làm việc đa chức năng.', en: 'As staffing scales, authorization becomes a major challenge. Our security system is designed with a <em>"right person, right job"</em> mindset. Smart RBAC allows managers to easily set access limits per department or employee. Sensitive data is strictly protected, preventing unwanted interference while ensuring smooth workflows for cross-functional teams.' },
  'about.h2.3': { vi: '3. Minh bạch mọi dấu vết với nhật ký hoạt động', en: '3. Total Transparency with Activity Logs' },
  'about.p2.3': { vi: 'Sự minh bạch là chìa khóa của niềm tin. Với tính năng theo dõi qua nhật ký hoạt động, mọi thao tác dù là nhỏ nhất của các tài khoản đều được hệ thống cẩn thận ghi chép lại. Ai đã xóa phiếu xuất kho này? Ai vừa chỉnh sửa thông tin nhà cung cấp? Tất cả thay đổi đều có thể được tra cứu lại lịch sử một cách chi tiết. Điều này giúp cho việc giám sát trở nên trực quan hơn bao giờ hết và loại bỏ hoàn toàn những rủi ro về thất thoát thông tin.', en: 'Transparency is the key to trust. With activity logging, every action, no matter how small, is carefully recorded. Who deleted this export receipt? Who edited supplier info? All changes can be traced back in detail. This makes supervision more visual than ever and completely eliminates risks of information loss.' },
  'about.h2.4': { vi: '4. Giải phóng sức lao động với tự động hóa nhập liệu', en: '4. Free Up Labor with Automated Data Entry' },
  'about.p2.4': { vi: 'Chúng tôi biết rằng việc phải nhập liệu thủ công hàng trăm mã hàng hóa là một công việc nhàm chán và dễ dẫn đến sai sót. Tính năng <strong>Nhập liệu từ Excel</strong> của chúng tôi được sinh ra để thay đổi điều đó. Chỉ với một cú click, phần mềm sẽ tự động nhận diện các cột, trích xuất dữ liệu hàng loạt từ file Excel của bạn. Thông minh hơn, hệ thống sẽ tự động rà soát, phát hiện và cảnh báo ngay lập tức nếu có bất kỳ sự trùng lặp dữ liệu nào, giúp bạn tiết kiệm hàng giờ đồng hồ làm việc.', en: 'We know manual data entry for hundreds of items is tedious and error-prone. Our <strong>Excel Import</strong> feature was born to change that. With just one click, the software auto-detects columns and extracts bulk data from your Excel file. Smarter still, the system auto-reviews, detects, and instantly alerts on any data duplication, saving you hours of work.' },
  'about.h2.5': { vi: '5. Truy cập mọi nơi, trải nghiệm đa ngôn ngữ', en: '5. Access Anywhere, Multilingual Experience' },
  'about.p2.5a': { vi: 'Sự linh hoạt là yếu tố sống còn trong thời đại số. Hệ thống của chúng tôi được tối ưu hóa để hoạt động mượt mà không chỉ trên máy tính, mà còn trên điện thoại di động và máy tính bảng. Bất kể bạn đang đi công tác hay ngồi tại quán cà phê, bạn vẫn có thể duyệt đơn hàng và theo dõi tồn kho theo thời gian thực.', en: 'Flexibility is vital in the digital age. Our system is optimized to run smoothly not just on desktops, but also on mobiles and tablets. Whether you are on a business trip or sitting in a cafe, you can still browse orders and track real-time inventory.' },
  'about.p2.5b': { vi: 'Không dừng lại ở đó, ForgeCore cung cấp trải nghiệm đa ngôn ngữ linh hoạt cùng khả năng tùy chỉnh định dạng ngày tháng, tiền tệ. Tất cả nhằm mục đích mang lại cảm giác thân thuộc và phù hợp nhất với quy mô, thói quen của doanh nghiệp bạn trên con đường hội nhập toàn cầu.', en: 'Beyond that, ForgeCore provides a flexible multilingual experience alongside customizable date and currency formats. All aimed at bringing the most familiar and suitable feel to your business scale and habits on the path to global integration.' },

  // Usage Page
  'usage.title': { vi: 'Hướng Dẫn Sử Dụng <span class="accent">ForgeCore</span>', en: 'User Guide for <span class="accent">ForgeCore</span>' },
  'usage.sub': { vi: 'Cùng điểm qua luồng thao tác cơ bản để đưa doanh nghiệp của bạn vào vận hành trơn tru và hiệu quả.', en: 'Let\'s review the basic workflow to get your business running smoothly and efficiently.' },
  'usage.p1': { vi: 'Chào mừng bạn đến với hướng dẫn sử dụng <strong>ForgeCore</strong>. Dưới đây là các bước thao tác cơ bản nhất giúp bạn nhanh chóng làm quen và đưa hệ thống vào vận hành thực tế cho doanh nghiệp của mình một cách trơn tru.', en: 'Welcome to the <strong>ForgeCore</strong> user guide. Below are the most basic steps to help you quickly get acquainted and put the system into practical operation for your business smoothly.' },
  'usage.toc': { vi: 'Mục lục', en: 'Table of Contents' },
  'usage.toc.1': { vi: '1. Khởi tạo & Thiết lập', en: '1. Initialization & Setup' },
  'usage.toc.2': { vi: '2. Thêm mới vật tư', en: '2. Add New Materials' },
  'usage.toc.3': { vi: '3. Quản lý kho & Vận chuyển', en: '3. Inventory & Transport' },
  'usage.toc.4': { vi: '4. Báo cáo phân tích', en: '4. Analytical Reports' },
  'usage.h2.1': { vi: '1. Khởi tạo tài khoản và thiết lập thông tin', en: '1. Account Initialization and Information Setup' },
  'usage.p2.1a': { vi: 'Ngay sau khi nhận được tài khoản từ hệ thống, bước đầu tiên và bắt buộc là bạn cần <strong>đổi mật khẩu lần đầu</strong> để đảm bảo an toàn tuyệt đối cho dữ liệu doanh nghiệp.', en: 'Right after receiving your account from the system, the first mandatory step is to <strong>change your password</strong> to ensure absolute safety for business data.' },
  'usage.p2.1b': { vi: 'Sau khi đổi mật khẩu và đăng nhập thành công, hệ thống sẽ tự động điều chỉnh giao diện hiển thị các tính năng dựa trên vai trò phân quyền của bạn. Tiếp theo, hãy truy cập phần <strong>Cài đặt</strong> để thiết lập các thông số chung. Bạn có thể tùy chỉnh các cấu hình quan trọng như tiền tố cho mã phiếu xuất/nhập kho (ví dụ: <code>PX-</code>, <code>PN-</code>), hay chọn định dạng tiền tệ (VNĐ, USD) sao cho phù hợp với thói quen kinh doanh của tổ chức nhất.', en: 'After successfully changing the password and logging in, the system will auto-adjust the UI features based on your authorized role. Next, access <strong>Settings</strong> to configure general parameters. You can customize important configs like prefixes for import/export receipts (e.g., <code>PX-</code>, <code>PN-</code>), or choose the currency format (VND, USD) to best suit your organization\'s habits.' },
  'usage.h2.2': { vi: '2. Thêm Mới Vật Tư Dễ Dàng', en: '2. Add Materials Easily' },
  'usage.p2.2': { vi: 'Bước tiếp theo để hệ thống có thể hoạt động là đưa dữ liệu hàng hóa, vật tư vào danh mục. Để làm điều này, bạn có thể thực hiện theo hai cách:', en: 'The next step for the system to operate is to input goods and material data into the catalog. You can do this in two ways:' },
  'usage.li.2a': { vi: '<strong>Nhập thủ công:</strong> Bấm vào nút "Thêm mới" và điền thông tin chi tiết cho từng loại vật tư.', en: '<strong>Manual Entry:</strong> Click "Add New" and fill in the details for each material.' },
  'usage.li.2b': { vi: '<strong>Nhập tự động qua Excel:</strong> Tải lên một file danh sách Excel có sẵn. ForgeCore sẽ thông minh tự động nhận diện các cột dữ liệu (như tên hàng hóa, mã SKU, danh mục, đơn vị tính, số lượng) và cập nhật hàng loạt vào hệ thống chỉ trong vài giây.', en: '<strong>Auto Import via Excel:</strong> Upload an existing Excel list. ForgeCore will smartly detect data columns (like item name, SKU, category, unit, quantity) and bulk update the system in seconds.' },
  'usage.h2.3': { vi: '3. Quản Lý Giao Dịch Kho', en: '3. Inventory Transaction Management' },
  'usage.p2.3': { vi: 'Sau khi dữ liệu vật tư đã sẵn sàng, bạn có thể bắt đầu xử lý các giao dịch hàng ngày. Mỗi khi có lô hàng mới nhập về hoặc xuất đi, bạn chỉ cần điều hướng đến mục <strong>Phiếu Kho</strong> và tạo lệnh tương ứng. Ngay sau khi phiếu được duyệt và hoàn thành, số lượng tồn kho của các mặt hàng liên quan sẽ tự động được cộng hoặc trừ tương ứng theo thời gian thực. Điều này đảm bảo số liệu trên phần mềm luôn khớp chính xác tuyệt đối với số lượng thực tế trong kho.', en: 'Once material data is ready, you can start processing daily transactions. Whenever a new shipment arrives or leaves, simply navigate to <strong>Warehouse Receipts</strong> and create the corresponding order. Once the receipt is approved and completed, the related inventory quantities will auto-adjust in real-time. This ensures software data perfectly matches actual warehouse quantities.' },
  'usage.h2.4': { vi: '4. Báo Cáo Phân Tích Kịp Thời', en: '4. Timely Analytical Reports' },
  'usage.p2.4': { vi: 'Nhờ vào việc các giao dịch được ghi nhận liên tục, trang <strong>Báo Cáo</strong> sẽ trở thành công cụ đắc lực của bạn. Tại đây, bạn có thể dễ dàng xem lại toàn bộ hoạt động kinh doanh, xuất nhập tồn theo ngày, tháng hoặc năm. Các số liệu được trình bày dưới dạng biểu đồ sinh động giúp bạn nhanh chóng nắm bắt xu hướng. Khi cần thiết, bạn có thể xuất báo cáo ra file Excel với đầy đủ màu sắc, định dạng chuẩn chỉnh để sử dụng cho các cuộc họp quan trọng hoặc gửi đối tác.', en: 'Because transactions are continuously recorded, the <strong>Reports</strong> page becomes your powerful tool. Here, you can easily review all business activities and inventory by day, month, or year. Metrics are presented in vivid charts helping you quickly grasp trends. When needed, you can export color-coded, properly formatted Excel reports for key meetings or partners.' }
